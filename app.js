const dashboard = {
  ...
  agents: [
    ...
    },
    {
      ...
      actions: ['Standing by for campaign strategy work'],
    },
    {
      name: 'LeadDiscovery',
    ...
    },
    {
      ...
      actions: ['Waiting for approved leads and outbound call batch'],
    },
    {
      name: 'Scheduler',
    ...
    },
    {
      ...
      actions: ['Standing by for campaign execution'],
    },
    {
      name: 'support-pro',
      ...
      actions: ['Standing by for support workflow assignments'],
    },
  ],
  missions: [
    {
